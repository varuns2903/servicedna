...
public class OrganizationController {
    ...
    public ResponseEntity<OrganizationDto> createOrganization(
        ...
        return new ResponseEntity<>(organizationService.createOrganization(request, userDetails.getUser().getId()), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<List<OrganizationDto>> getUserOrganizations(
        ...
        return ResponseEntity.ok(organizationService.getUserOrganizations(userDetails.getUser().getId()));
    }
