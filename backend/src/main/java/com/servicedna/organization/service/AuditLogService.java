...
public class AuditLogService {
    ...
    public AuditLogService(AuditLogRepository auditLogRepository, OrganizationRepository organizationRepository, UserRepository userRepository, OrganizationService organizationService) {
    ...
    public void logAction(UUID organizationId, UUID userId, String action, String entityType, String entityId, String details, String ipAddress) {
