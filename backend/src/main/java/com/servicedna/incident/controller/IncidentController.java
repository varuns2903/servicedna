...
public class IncidentController {
    ...
    public ResponseEntity<PostMortemDto> upsertPostMortem(
        ...
        return ResponseEntity.ok(incidentService.upsertPostMortem(orgId, incidentId, request, userDetails.getUser().getId()));
    }
    ...
    public ResponseEntity<PostMortemDto> getPostMortem(
        ...
        return ResponseEntity.ok(incidentService.getPostMortem(orgId, incidentId, userDetails.getUser().getId()));
    }
}
