...
public class Incident {
    ...
    public Incident(UUID id, Organization organization, User createdBy, String title, String description, IncidentSeverity severity) {
        this.id = id;
    ...
    public Set<Service> getAffectedServices() { return affectedServices; }
    public void setAffectedServices(Set<Service> affectedServices) { this.affectedServices = affectedServices; }
